Rails.application.routes.draw do
  ...
  get 'users/id:id' => 'users#show', as: 'user'
  post 'users/login' => 'users#login'
  get 'users/id:id/about' => 'users#get_about'
  get 'users/id:id/login' => 'users#get_login'
  post 'users/about' => 'users#about'
  post 'avatar' => 'users#avatar', as: 'avatar', defaults: { format: 'js' }
  post 'users/id:id/follow' => 'users#follow'
  post 'users/id:id/unfollow' => 'users#unfollow'
  ...
  post 'posts/id:id/like' => 'posts#like', as: 'like', defaults: { format: 'js' }
  post 'posts/id:id/dislike' => 'posts#dislike', as: 'dislike', defaults: { format: 'js' }
